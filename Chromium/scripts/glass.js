...
const SomtodayGlass = (() => {
    const groups = [
        ...
        { id: 'panels', label: 'Pop-ups, zijpanelen en Mod-menu', scopes: ['sl-sidebar > .content-container', 'sl-modal .content-container', 'sl-sidebar-page', 'hmy-popup', 'sl-popup', 'sl-leerling-menu-acties'], surfaces: ['sl-sidebar > .content-container', 'sl-modal .content-container', 'sl-sidebar-page', 'hmy-popup', 'sl-popup'] },
